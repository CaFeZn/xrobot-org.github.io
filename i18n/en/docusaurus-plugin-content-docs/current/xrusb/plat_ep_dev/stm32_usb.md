...
| --------------------- | ----- | ---- | ----- |
| `USB_BASE / FSDEV` | `LibXR::STM32USBDeviceDevFs` | Device | FSDEV / DRD FS device-side path |
| `USB_OTG_FS` | `LibXR::STM32USBDeviceOtgFS` | Device side of OTG FS | OTG FS device path |
| `USB_OTG_HS` | `LibXR::STM32USBDeviceOtgHS` | Device side of OTG HS | OTG HS device path |
